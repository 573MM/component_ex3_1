...
public class CustomerMailApplication {
    ...
    public static void main(String[] args) {
        ...
        switch(type) {
            case 1:
                //customer.CustomerFactory.getCustomerTypeFromUser("Regular");
                customer = CustomerFactory.getCustomerTypeFromUser("Regular");
                break;
            case 2:
                customer = CustomerFactory.getCustomerTypeFromUser("Mountain");
                break;
            case 3:
                customer = CustomerFactory.getCustomerTypeFromUser("Delinquent");
                break;
